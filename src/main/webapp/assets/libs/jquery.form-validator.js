    ...
    $.formUtils = {
        ...
        */
        LANG : {
            ...
            requiredFields : 'Des champs sont obligatoires',
            badTime : 'Format de la date est incorrect',
            badEmail : 'Adresse e-mail non valide',
            badTelephone : 'You have not given a correct phone number',
            badSecurityAnswer : 'You have not given a correct answer to the security question',
            badDate : 'Date pas valide',
            lengthBadStart : 'La valeur du champs doit etre entre ',
            lengthBadEnd : ' caracteres',
            lengthTooLongStart : 'La valeur du champs est superieure  a',
            lengthTooShortStart : 'La valeur du champs est inferieur a ',
            notConfirmed : 'Input values could not be confirmed',
            badDomain : 'Incorrect domain value',
            badUrl : 'The input value is not a correct URL',
            badCustomVal : 'La valeur du champs est incorrecte',
            badInt : 'La valeur du champs n\'est pas correcte',
            badSecurityNumber : 'Your social security number was incorrect',
            badUKVatAnswer : 'Incorrect UK VAT Number',
            badStrength : 'Le mot de passe est faible',
            badNumberOfSelectedOptionsStart : 'You have to choose at least ',
            badNumberOfSelectedOptionsEnd : ' answers',
            badAlphaNumeric : 'Le champs peut contenir que les caracteres alphanumeriques',
